...
(function()
{
	...
	if (window.StyleFormatPanel != null)
	{
		...
		StyleFormatPanel.prototype.addEditOps = function(div)
		{
			...
			if (this.editorUi.editor.graph.getSelectionCount() == 1)
			{
				btn = mxUtils.button(mxResources.get('showproperties'), mxUtils.bind(this, function(evt)
				{
					this.editorUi.actions.get('showproperties').funct();
				}));
				
				btn.setAttribute('title', mxResources.get('showproperties') + ' (' + this.editorUi.actions.get('showproperties').shortcut + ')');
				btn.style.width = '202px';
				btn.style.marginBottom = '2px';
