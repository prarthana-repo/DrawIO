 ...
 * Returns information about the current selection.
 */
Format.prototype.showPreview = true;
...
{
	var btn = mxUtils.button(mxResources.get('customButtonData'), mxUtils.bind(this, function(evt)
	{
		this.editorUi.actions.get('customButtonData').funct();
	}));
