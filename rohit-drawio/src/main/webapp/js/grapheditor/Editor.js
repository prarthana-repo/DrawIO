...
var FormPropertyDialog = function(editorUi)
{
	var graph = editorUi.editor.graph;
	var row, td;
	...
	var addSelectBox = function(name){
		var row, td;
		row = document.createElement('tr');
		...
		var pf = new Object();
	     var formats = FormPropertyDialog.getFormats();
	...
	for (var i = 0; i < formats.length; i++)
	{
		...
		mxEvent.addListener(selectBox, 'change', function(evt)
		{
			var f = pf[selectBox.value];
			alert(f);
			
		});

	}
var addRadioButton = function(name){
	var row, td;
		row = document.createElement('tr');
	...
	CheckBox1.setAttribute('value', 'Zone');
	...
	CheckBox1.style.marginRight = '6px';
	formatDiv.appendChild(CheckBox1);
	
	var checkboxSpan = document.createElement('span');
	checkboxSpan.style.maxWidth = '100px';
	mxUtils.write(checkboxSpan, "Zone");
	formatDiv.appendChild(checkboxSpan);

		td.appendChild(CheckBox1);
		row.appendChild(td);
		tbody.appendChild(row);

		mxEvent.addListener(CheckBox1, 'change', function(evt)
	{
	...
	addInputBox("Display Name");
	addInputBox("Project");
	addSelectBox("Formats");
	addRadioButton("");
...
// Prarthana added new form dialog 


FormPropertyDialog.getFormats = function()
{
